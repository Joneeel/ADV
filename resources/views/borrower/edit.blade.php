...
<head>
    ...
    <title>EDIT BORROWER'S INFORMATION (LMS) </title>
</head>
<center>
    ...
    <div class="inputbg">
        ...
        <div class="row">
            <div class="offset-md-3 col-md-6">
                <form class="yourform" action="{{ route('borrowereditprocess')}}" method="any" autocomplete="off">
                    @csrf
                    <div>
                        <label>Borrower_id: </label>
                        <input type="text" class="inputs" name="Borrower_id" value="{{ $Borrower_id }}" readonly>
                    </div>
                    <div>
                    ...
                    <div>
                        <label>Address: </label>
                        <input type="text" class="inputs" name="address" value="{{ $address }}" required>
                    </div>
...
.imagebg{
    ...
    background-image: url("{{ asset('Image/bg6.png') }}");
